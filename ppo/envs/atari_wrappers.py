# Code from https://ai.atamai.biz/files/atari_wrappers.py
...
def wrap_deepmind(env, episode_life=True, clip_rewards=True, frame_stack=False, scale=False, pytorch_img=False, atari=True):
